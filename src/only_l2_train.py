...
parser.add_argument('--imageSize', type=int, default=227, help='the height / width of the input image to network')
...
#                 errD.data[0], errG_D.data[0],errG_l2.data[0], D_x,D_G_z1, ))
        #print(errG_l2.item())
        epoch_loss = epoch_loss + errG_l2.item() 
        if i % 100 == 0:
    ...
    #            'model/netlocalD.pth' )
all_epoch_loss = np.array(all_epoch_loss)
np.save("epochLoss.npy", all_epoch_loss)
